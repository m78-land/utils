...
/** 以统一格式抛出错误 */
export declare function throwError(msg: string, prefix?: string | undefined): never;
/** 以统一格式抛出警告 */
export declare function throwWarning(msg: string, prefix?: string | undefined): void;
